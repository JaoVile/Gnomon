...
// Exemplo de rota mock (substitua pela sua rota real quando tiver)
    ...
    <div id="map-container">
      {mode === '3d' ? (
        ...
        <MapContainer center={position} zoom={18} scrollWheelZoom style={{ height: '100%', width: '100%' }}>
          ...
          {/* Outras rotas/estados */}
          {/* <Polyline positions={mockPath} pathOptions={{ color: routeAccessible, weight: 7, opacity: 0.95 }} /> */}
          {/* <Polyline positions={mockPath} pathOptions={{ color: routeRestricted, weight: 6, opacity: 0.6, dashArray: '6 8' }} /> */}
        </MapContainer>
      )}
    </div>
  </main>
